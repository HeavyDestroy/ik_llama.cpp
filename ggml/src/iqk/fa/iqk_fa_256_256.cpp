...
IQK_FA_CASE(iqk_fa_256_256) {
    ...
    // and reduced loop overhead. 256*256*2 = 128KB fits comfortably in 2MB L2.
    ...
    // AMX (Advanced Matrix Extensions): 16x16 tiles optimize for D_HEAD=256
    // Use K_CHUNK=128 to align with AMX tile boundaries (256/16 = 16 tiles)
    if (nq > 1 && nk%128 == 0) {
